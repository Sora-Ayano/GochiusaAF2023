...
function gamePassengerDot(e){
	...
	const passenger = cElement('div','passenger'),
		  ...
		  passengerBirthday = createTextElement('div','passenger__birthday','生日'+_passengerDataBirthday),
	...
	passengerCallBtnTrue.append('打招呼')
	passengerCallBtnFalse.setAttribute('call','false')
	passengerCallBtnFalse.append('默默离去')
...
function goEndingComics(){
	...
	const comics = cElement('div','comics'),
		  ...
		  comicsHead = createTextElement('div','comics-head','特别影片'),
...
function goEndingInfo(){
	...
	const info = cElement('div','info'),
		  ...
		  infoText = createTextElement('div','info__text','感谢您乘坐本次列车。<br>现在正在举办纪念邮戳盖章活动。<br>请按照经停站顺序填写车站名<br>来领取专属礼物吧。<br>请一定要参加哟。'),
...
function goStamp(){
	...
	const stamp = cElement('div','stamp'),
		  ...
		  stampHeadH2 = createTextElement('h2','','银河特急Rabbit House号'),
	...
	const stampFormMax = 7,
		  stampFormSeiza = [
			  ...
			  {key:"libra",val:"天秤座"},
			  {key:"scorpio",val:"天蝎座"},
			  {key:"sagittarius",val:"射手座"},
			  {key:"capricorn",val:"摩羯座"},
			  {key:"aquarius",val:"水瓶座"},
			  {key:"pisces",val:"双鱼座"},
		  ];
